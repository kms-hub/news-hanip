...
| Revision date | Version # | Description | Author |<br><br>
| 2026/06/03 | 1.00 | Design 문서 초안 작성 | 김명섭 |<br>
| 2026/06/03 | 1.01 | 다이어그램 이미지 및 설명 추가 | 김명섭 |<br>
| 2026/06/03 | 1.02 | 구현 요구사항, 용어사전, 참고문헌 정리 | 김명섭 |<br>
...
[![Class Diagram](../images/design/class-diagram.png)](../images/design/class-diagram.png)
...
[![Sequence Diagram - Open App by Notification](../images/design/sequence-open-app-by-notification.png)](../images/design/sequence-open-app-by-notification.png)
...
[![Sequence Diagram - Subscribe Category and Time](../images/design/sequence-subscribe-category-time.png)](../images/design/sequence-subscribe-category-time.png)
...
[![Sequence Diagram - Fetch Articles and Summarize](../images/design/sequence-fetch-summarize.png)](../images/design/sequence-fetch-summarize.png)
...
[![Sequence Diagram - Set Silent Time](../images/design/sequence-set-silent-time.png)](../images/design/sequence-set-silent-time.png)
...
[![Sequence Diagram - Mark as Read](../images/design/sequence-mark-as-read.png)](../images/design/sequence-mark-as-read.png)
...
[![Sequence Diagram - Save Article](../images/design/sequence-save-article.png)](../images/design/sequence-save-article.png)
...
[![Sequence Diagram - Read Full Text](../images/design/sequence-read-full-text.png)](../images/design/sequence-read-full-text.png)
...
[![Sequence Diagram - Pause and Resume Delivery](../images/design/sequence-pause-resume-delivery.png)](../images/design/sequence-pause-resume-delivery.png)
...
[![Sequence Diagram - Language Setting](../images/design/sequence-language-setting.png)](../images/design/sequence-language-setting.png)
...
아래의 그림은 시스템의 기능 중 “Open Settings”에 대한 Sequence Diagram이다.

[![Sequence Diagram - Open Settings](../images/design/sequence-open-settings.png)](../images/design/sequence-open-settings.png)

사용자가 “HomeScreen”에서 설정 메뉴를 선택하면 “App” 클래스는 “SettingsScreen”으로 화면 이동을 수행한다. “SettingsScreen”은 실행되면서 “UserSettings” 클래스에 저장되어 있는 카테고리, 알림 시간, 무음 시간, 언어 설정 정보를 불러온다. 불러온 설정값은 설정 화면에 표시되고, 사용자는 현재 저장된 설정 상태를 확인하거나 수정할 수 있다.
...
[![State Machine Diagram](../images/design/state-machine-diagram.png)](../images/design/state-machine-diagram.png)
